...
from ...services.v1.UserService import UserService
...
class Collection(Resource):
    ...
    @h.returns(
        ...
        collection_links=lambda content: [url_for("v2.users_collection")],
    )
    @jwt_required()
    def get(self):
    ...
    @h.returns(
        user_dto,
        self_links=lambda content: [url_for("v2.users_item", userId=content["id"])],
        collection_links=lambda content: [url_for("v2.users_collection")],
    )
    def post(self):
