...
class Collection(Resource):
    ...
    @h.returns(
        ...
        collection_links=lambda content: [] if len(content) == 0 else [url_for( "v2.copies_collection", titleId=content[0]["titleId"])],
    )
    ...
    @h.returns(
        copy_dto,
        self_links=lambda content: [url_for("v2.copies_item", titleId=content["titleId"], copyId=content["id"])],
        collection_links=lambda content: [url_for("v2.copies_collection", titleId=content["titleId"])],
    )
    @jwt_required()
