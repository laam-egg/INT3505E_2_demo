...
from .services import title_service as service
...
class Collection(Resource):
    ...
    @h.returns(
        ...
        collection_links=lambda content: [url_for("v4.titles_collection")],
    )
    def get(self):
    ...
    @h.returns(
        title_dto,
        self_links=lambda content: [url_for("v4.titles_item", titleId=content["id"])],
        collection_links=lambda content: [url_for("v4.titles_collection")],
    )
    @jwt_required()
    def post(self):
